...
public class SchoolPieces {
	...
	private static final ResourceLocation location = new ResourceLocation("moreore:school");

	public static void generate(TemplateManager templateManager, BlockPos pos, Rotation rotation,
			List<StructurePiece> pieces, Random random) {
		pieces.add(new SchoolPieces.Piece(templateManager, location, pos,
				rotation, 0));
	}
	...
	public static class Piece extends TemplateStructurePiece {
		...
		public Piece(TemplateManager templateManager, ResourceLocation location, BlockPos pos, Rotation rotation,
				int componentTypeIn) {
			super(IStructurePieceType.register(SchoolPieces.Piece::new, SchoolStructure.SHORT_NAME),
					componentTypeIn);
		...
		public Piece(TemplateManager templateManager, CompoundNBT cNBT) {
			super(IStructurePieceType.register(SchoolPieces.Piece::new, SchoolStructure.SHORT_NAME), cNBT);
