...
public class TempelPieces {
	...
	private static final ResourceLocation location = new ResourceLocation("moreore:tempel");
	...
	public static class Piece extends TemplateStructurePiece {
		...
		public Piece(TemplateManager templateManager, CompoundNBT cNBT) {
			super(IStructurePieceType.register(TempelPieces.Piece::new, TempelStructure.SHORT_NAME), cNBT);
