...
public class SilverTree extends BigTree {
	...
	public static final BaseTreeFeatureConfig HUGE_SILVER_TREE_CONFIG = (new BaseTreeFeatureConfig.Builder(
	...
	protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random randomIn, boolean b) {
		return Feature.field_236291_c_.withConfiguration(SILVER_TREE_CONFIG);
	}

	@Override
	public ConfiguredFeature<BaseTreeFeatureConfig, ?> getHugeTreeFeature(Random p_225547_1_) {
		return Feature.field_236291_c_.withConfiguration(HUGE_SILVER_TREE_CONFIG);
	}
}