...
public class SilverNetherChunkGenerator extends NoiseChunkGenerator<SilverGenSettings> {
	   private final double[] field_222573_h = this.func_222572_j();

	   public SilverNetherChunkGenerator(World p_i48694_1_, BiomeProvider p_i48694_2_, SilverGenSettings silverGenSettings) {
	      super(p_i48694_1_, p_i48694_2_, 4, 8, 128, silverGenSettings, false);
	   }
