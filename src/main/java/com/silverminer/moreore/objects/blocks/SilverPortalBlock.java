...
public class SilverPortalBlock extends BreakableBlock
{
	...
	public void onEntityCollision(BlockState state, World worldIn, BlockPos pos, Entity entity){
		if (!worldIn.isRemote && entity.isAlive() && !entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() &&
			VoxelShapes.compare(VoxelShapes.create(entity.getBoundingBox().offset((double)(-pos.getX()), (double)(-pos.getY()), (double)(-pos.getZ()))), state.getShape(worldIn, pos), IBooleanFunction.AND)){
			...
			RegistryKey<World> dim = entity.world.func_230315_m_() == DimensionType.byName(MoreOre.SILVER_DIM_TYPE) ? DimensionType.field_235999_c_ : DimensionType.byName(MoreOre.SILVER_DIM_TYPE);
