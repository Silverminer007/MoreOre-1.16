 ...
 *
 * @author Cadiboo
 * @Comment Thanks Thanks Thanks!!! I searched for an Solution for hours. Here i have found it!!! Thanks!!!
 */
public class ModSpawnEggItem extends SpawnEggItem {
	...
	public ModSpawnEggItem(final NonNullSupplier<? extends EntityType<?>> entityTypeSupplier, final int p_i48465_2_,
	...
	public ModSpawnEggItem(final RegistryObject<? extends EntityType<?>> entityTypeSupplier, final int p_i48465_2_,
			final int p_i48465_3_, final Properties p_i48465_4_) {
		super(null, p_i48465_2_, p_i48465_3_, p_i48465_4_);
