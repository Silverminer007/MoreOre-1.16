...
public class PurplehouseStructure extends AbstractStructure<NoFeatureConfig> {
	public static final String SHORT_NAME = "purple_house";

	public PurplehouseStructure(Codec<NoFeatureConfig> configFactoryIn) {
		super(configFactoryIn, 3, SHORT_NAME);
	}

	@Override
	public double getSpawnChance() {
		return Config.STRUCTURES.PURPLE_HOUSE.SPAWN_CHANCE.get();
	}

	public int getSeedModifier() {
		return Config.STRUCTURES.PURPLE_HOUSE.SEED.get();
	}
	...
	public int getDistance() {
		return Config.STRUCTURES.PURPLE_HOUSE.DISTANCE.get();
	}

	@Override
	public int getSeparation() {
		return Config.STRUCTURES.PURPLE_HOUSE.SEPARATION.get();
	}
	...
	public static class Start extends AbstractStructureStart<NoFeatureConfig> {
		...
		public void func_230364_a_(DynamicRegistries registries, ChunkGenerator chunkGenerator,
			...
			PurplehousePieces.generate(templateManager, blockpos, rotation, this.components, this.rand);
