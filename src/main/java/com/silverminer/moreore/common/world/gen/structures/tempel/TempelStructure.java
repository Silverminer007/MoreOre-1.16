...
public class TempelStructure extends AbstractStructure<NoFeatureConfig> {
	...
	public double getSpawnChance() {
		return Config.STRUCTURES.TEMPEL.SPAWN_CHANCE.get();
	}

	public int getSeedModifier() {
		return Config.STRUCTURES.TEMPEL.SEED.get();
	}
	...
	public int getDistance() {
		return Config.STRUCTURES.TEMPEL.DISTANCE.get();
	}

	@Override
	public int getSeparation() {
		return Config.STRUCTURES.TEMPEL.SEPARATION.get();
	}
	...
	public static class Start extends AbstractStructureStart<NoFeatureConfig> {
		...
		public void generatePieces(DynamicRegistries registries, ChunkGenerator chunkGenerator,
			...
			TempelPieces.generate(templateManager, blockpos, rotation, this.pieces, this.random);
