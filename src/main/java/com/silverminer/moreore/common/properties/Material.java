...
public enum Material implements IStringSerializable {
	BEAMER("beamer"), ANDESITE("andesite"), OAK_PLANKS("oak_planks"), COBBLESTONE("cobblestone"), STONE("stone"),
	EMERALD_ORE("emerald_ore"), DIRT("dirt"), ICE("ice"), DIAMOND_ORE("diamond_ore"), BOOKSHELF("bookshelf"),
	GOLD_BLOCK("gold_block"), RAINBOW_BLOCK("rainbow_block"), EMERALD_BLOCK("emerald_block"),
	DIAMOND_BLOCK("diamond_block"), IRON_BLOCK("iron_block"), ALEXANDRIT_BLOCK("alexandrit_block"),
	RAINBOW_ORE("rainbow_ore"), SPRUCE_PLANKS("spruce_planks"), ALEXANDRIT_ORE("alexandrit_ore"),
