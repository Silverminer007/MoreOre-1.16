...
public class TreeItems {
	...
	public static final RegistryObject<Item> BLUE_STICK = InitItems.registerCompostItems("blue_stick",
			() -> new Item(new Item.Properties().tab(ModItemGroups.BIOLOGIC)), 0.3F);
	...
	public static final RegistryObject<Item> SILVER_LOG = InitItems.registerCompostItems("silver_logs",
			() -> new BlockItem(BiologicBlocks.SILVER_LOG.get(), new Item.Properties().tab(ModItemGroups.BIOLOGIC)), 0.3F);

	public static final RegistryObject<Item> STRIPPED_SILVER_LOG = InitItems.registerCompostItems("stripped_silver_logs",
			() -> new BlockItem(BiologicBlocks.STRIPPED_SILVER_LOG.get(), new Item.Properties().tab(ModItemGroups.BIOLOGIC)), 0.3F);
	...
	public static final RegistryObject<Item> SILVER_LEAVES = InitItems.registerCompostItems("silver_leaves",
			() -> new BlockItem(BiologicBlocks.SILVER_LEAVES.get(),
					new Item.Properties().tab(ModItemGroups.BIOLOGIC)), 0.3F);
	...
	public static final RegistryObject<Item> SILVER_WOOD = InitItems.registerCompostItems("silver_wood",
			() -> new BlockItem(BiologicBlocks.SILVER_WOOD.get(), new Item.Properties().tab(ModItemGroups.BIOLOGIC)), 0.3F);

	public static final RegistryObject<Item> SILVER_WALL = ITEMS.register("silver_wall",
			() -> new BlockItem(BiologicBlocks.SILVER_WALL.get(), new Item.Properties().tab(ModItemGroups.BIOLOGIC)));
	...
	public static final RegistryObject<Item> GOLD_LEAVES = InitItems.registerCompostItems("gold_leaves",
			() -> new BlockItem(BiologicBlocks.GOLD_LEAVES.get(), new Item.Properties().tab(ModItemGroups.BIOLOGIC)), 0.3F);
	...
	public static final RegistryObject<Item> ICE_LEAVES = InitItems.registerCompostItems("ice_leaves",
			() -> new BlockItem(BiologicBlocks.ICE_LEAVES.get(), new Item.Properties().tab(ModItemGroups.BIOLOGIC)), 0.3F);

	public static final RegistryObject<Item> ICE_SAPLING = InitItems.registerCompostItems("ice_saplings",
			() -> new BlockItem(BiologicBlocks.ICE_SAPLING.get(), new Item.Properties().tab(ModItemGroups.BIOLOGIC)), 0.3F);
	...
	public static final RegistryObject<Item> NUTS = InitItems.registerCompostItems("nut",
			() -> new BlockNamedItem(BiologicBlocks.NUT_BUSH_SAPLING.get(), new Item.Properties().tab(ModItemGroups.BIOLOGIC)
					.food(new Food.Builder().nutrition(2).saturationMod(1.0f).fast().build())),
			0.3F);

	public static final RegistryObject<Item> NUT_BUSH_LEAVES = InitItems.registerCompostItems("nut_bush_leaves",
			() -> new BlockItem(BiologicBlocks.NUT_BUSH_LEAVES.get(), new Item.Properties().tab(ModItemGroups.BIOLOGIC)), 0.3F);
}