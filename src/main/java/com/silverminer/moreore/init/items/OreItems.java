...
public class OreItems {
	...
	public static final RegistryObject<Item> ALEXANDRIT_ORE = ITEMS.register("alexandrit_ore", 
			() -> new BlockItem(OreBlocks.ALEXANDRIT_ORE.get(), new Item.Properties().group(ModItemGroups.MINERALIC)));

	public static final RegistryObject<Item> ALEXANDRIT_BLOCK = ITEMS.register("alexandrit_block", 
			() -> new BlockItem(OreBlocks.ALEXANDRIT_BLOCK.get(), new Item.Properties().group(ModItemGroups.MINERALIC)));
	...
	public static final RegistryObject<Item> SILVER_BLOCK = ITEMS.register("silver_block", 
			() -> new BlockItem(OreBlocks.SILVER_BLOCK.get(), new Item.Properties().group(ModItemGroups.MINERALIC)));

	public static final RegistryObject<Item> CAT_GOLD_BLOCK = ITEMS.register("cat_gold_block", 
			() -> new BlockItem(OreBlocks.CAT_GOLD_BLOCK.get(), new Item.Properties().group(ModItemGroups.MINERALIC)));
	...
	public static final RegistryObject<Item> RUBIN_ORE = ITEMS.register("rubin_ore", 
			() -> new BlockItem(OreBlocks.RUBIN_ORE.get(), new Item.Properties().group(ModItemGroups.MINERALIC)));

	public static final RegistryObject<Item> RUBIN_BLOCK = ITEMS.register("rubin_block", 
			() -> new BlockItem(OreBlocks.RUBIN_BLOCK.get(), new Item.Properties().group(ModItemGroups.MINERALIC)));

	public static final RegistryObject<Item> SAPHIR_ORE = ITEMS.register("saphir_ore", 
			() -> new BlockItem(OreBlocks.SAPHIR_ORE.get(), new Item.Properties().group(ModItemGroups.MINERALIC)));

	public static final RegistryObject<Item> SAPHIR_BLOCK = ITEMS.register("saphir_block", 
			() -> new BlockItem(OreBlocks.SAPHIR_BLOCK.get(), new Item.Properties().group(ModItemGroups.MINERALIC)));
}
