...
public class TreeDecotratorInit {
	public static final DeferredRegister<TreeDecoratorType<?>> TYPES = DeferredRegister
			.create(ForgeRegistries.TREE_DECORATOR_TYPES, MoreOre.MODID);

	public static final RegistryObject<TreeDecoratorType<?>> BANANA = TYPES.register("banana",
			() -> new TreeDecoratorType<>(BananaTreeDecorator.CODEC));
}